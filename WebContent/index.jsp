...
<body>
	...
	<div class="container"><!--  vitar -->
		...
		<table class="table table-hover  table-striped">
			...
			<a href="add.jsp" type="button" class="btn btn-primary" >添加图书</a>
			
			
		<div class="row text-center">
			<ul class="pagination">
				<li><a href="Index?pageIndex=${pg.currPage-1 }">&laquo;</a></li>
						<c:forEach begin="1" end="${pg.totalPages}" varStatus="i">
							<li><a href="Index?pageIndex=${i.index} ">${i.index }</a></li>
						</c:forEach> 
				<li><a href="Index?pageIndex=${pg.currPage+1}">&raquo;</a></li>
				<li><a href="" >第${pg.currPage }页,共${pg.totalPages}页</a></li>
			</ul>
		</div>
